...
void ATopDownRPGCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATopDownRPGCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATopDownRPGCharacter::Look);

	}

}

void ATopDownRPGCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATopDownRPGCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
